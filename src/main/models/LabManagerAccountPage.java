...
public class LabManagerAccountPage extends JFrame {

	private JPanel contentPane;
	private User currentUser;

	public LabManagerAccountPage(User currentUser) {
		...
		btnManageItems.addActionListener(e -> {
			EquipmentManagementPage page = new EquipmentManagementPage(currentUser);
		...
		gl_panel_3_1_1_1.setHorizontalGroup(
			gl_panel_3_1_1_1.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel_3_1_1_1.createSequentialGroup()
					.addContainerGap()
					.addComponent(btnManageItems, GroupLayout.PREFERRED_SIZE, 271, GroupLayout.PREFERRED_SIZE)
					.addContainerGap(GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
		);
