...
public class EquipmentNotChosenError extends JDialog {

	private final JPanel contentPanel = new JPanel();
	private JButton okButton;
	private final JLabel lblNewLabel = new JLabel("Please select an equipment first!");
	 ...
	 * Create the dialog.
	 */
	public EquipmentNotChosenError() {
